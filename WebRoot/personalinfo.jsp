    ...
    <div class="page-content d-flex align-items-stretch">
      ...
      <nav class="side-navbar">
        ...
        <div class="sidebar-header d-flex align-items-center">
          ...
          <div class="title">
            <h1 class="h4">${loginUsername  }</h1>
          </div>
        </div>
        <ul class="list-unstyled">
          <!-- <li class="active"><a href="index.html"> <i class="icon-home"></i>主页面 </a></li> -->
          <li><a href="index.html" aria-expanded="false"> <i class="icon-interface-windows"></i>主页 </a></li>
...
=======
                              	<c:forEach items="${formal}" var="x">
	                              	 <tr>
	                              		...
	                              		<td><button class="btn btn-info">修改</button></td>
	                              		<td><button class="btn btn-dark">删除</button></td>
	                              	</tr>
                              	</c:forEach>
...
=======
                         <ul class="pagination" style="margin-left: 330px">
				            <li class="page-item"><a class="page-link" href="SybaseServlet?index=1">首页</a></li>
				            <li class="page-item"><a class="page-link" href="SybaseServlet?index=${pagelist.index-1 }">上一页</a></li>
				            <li class="page-item"><a class="page-link" href="SybaseServlet?index=1">1</a></li>
				            <li class="page-item"><a class="page-link" href="SybaseServlet?index=2">2</a></li>
				            <li class="page-item"><a class="page-link" href="SybaseServlet?index=3">3</a></li>
				            <li class="page-item"><a class="page-link" href="SybaseServlet?index=${pagelist.index-1 }">下一页</a></li>
				            <li class="page-item"><a class="page-link" href="SybaseServlet?index=${pagelist.pageCount }">尾页</a></li>
				            	<p>当前${pagelist.index }页，共${pagelist.pageCount }页</p>
				        </ul>
