                        ...
                        <div class="card-body">
                          <form class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" value="等待维修" disabled="disabled">
                                </div>
                                
                            </div>
                            <!-- <div class="form-group row">
                                <label class="col-sm-1 form-control-label text-center">物品名称</label>
                                <div class="col-sm-8">
                                  <input type="text" class="form-control">
                                </div>
                              </div>
                              <div class="form-group row">
                                  <label class="col-sm-1 form-control-label text-center">类型</label>
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control">
                                  </div>
                                </div> -->
