                  ...
                  <div class="card-body">
                    <form class="form-horizontal" action="InsterEmployeeServlet" method="post">
                      ...
                      <div class="col-sm-5 offset-sm-5">
                        <button type="submit" class="btn btn-secondary" onclick="window.location.href = 'http://localhost:8080/manager/memberexchange.jsp'">取消</button>
  	...
  	<!-- <script type="text/javascript">
  		$(function() {
  			$(".btn-primary").click(function(){
  				alert(1);
  				window.location.href="InsterEmployeeServlet";
  			});
